...
public class FindOrderDetailActivity extends NotifActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_order_detail);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.contentEquals("1")) {
                        ...
                        Intent i = new Intent(FindOrderDetailActivity.this,ViewOrderActivity.class);
                        i.putExtra("id_order",orderId);
                        startActivity(i);
                        finish();
