            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status.contentEquals("1")) {
                        ...
                        driver.phone = jObj.getString("phone");
                        driver.name = jObj.getString("name");
                        driver.username = jObj.getString("email");
                        driver.idDriver=jObj.getString("id_driver");
                        driver.plat=jObj.getString("plat");
