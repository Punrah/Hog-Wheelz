...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputFullName.setText("sugiono");
        inputEmail.setText("kakeksugiono1@gmail.com");
        inputPhone.setText("12345");
        inputPassword.setText("makan");
        inputConfirmPassword.setText("makan");
    ...
    private void registerUser(final String name, final String email, final String phone,
        ...
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("pass1", password);
                params.put("pass2", confirmPassword);
