...
public class HelpActivity extends RootActivity {
    ...
    public class uploadhelp extends MyAsyncTask {
        ...
        public void postData() {
            ...
            String url = AppConfig.UPLOAD_HELP;
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("kategori",code));
